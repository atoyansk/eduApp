...
export class CalendarPage {
  ...
  getDaysOfMonth() {
    ...
    if(totalDays<36) {
      for(var p = (7-lastDayThisMonth); p < ((7-lastDayThisMonth)+7); p++) {
        this.daysInNextMonth.push(p);
      }
    }
  }
  ...
  addCalendar(){
    let newCalModal = this.modalCtrl.create(NewCalendarPage, {cssClass:"cont-modal"});
    newCalModal.present();
  }
